...
function M.init()
    ...
    vim.keymap.set("n", "<cr>n", function() require 'telescope'.extensions.file_browser.file_browser({depth = 5, files = false}) end) -- file = false opens in 'folder-only' mode
    vim.keymap.set("n", "<cr>N", function() require 'telescope'.extensions.file_browser.file_browser({depth = 3}) end) -- file = false opens in 'folder-only' mode
