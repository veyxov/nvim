return {
    ...
    keys = {
        ...
        { "?n", function() Snacks.picker.diagnostics() end, desc = "Diagnostics" },
        { "?d", function() Snacks.explorer() end, desc = "File Explorer" },
        { "?e", function() Snacks.picker.lsp_symbols() end, desc = "LSP Symbols" },
        { "?i", function() Snacks.picker.lsp_workspace_symbols() end, desc = "LSP Workspace Symbols" },
        { "?a", function() Snacks.picker.lsp_incoming_calls() end, desc = "C[a]lls Incoming" },
