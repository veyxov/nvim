...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'gruvbox.nvim', 'vim-moonfly-colors', 'LuaSnip', 'nvim-surround', 'nvim-treesitter', 'smart-pairs'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
