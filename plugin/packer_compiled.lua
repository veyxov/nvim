...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-path", "cmp_luasnip", "cmp-nvim-lsp", "cmp-buffer", "cmp-cmdline" },
...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'gruvbox.nvim', 'vim-moonfly-colors', 'nvim-treesitter', 'LuaSnip', 'nvim-surround'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
