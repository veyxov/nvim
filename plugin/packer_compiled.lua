...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'nvim-treesitter', 'vim-moonfly-colors', 'gruvbox.nvim', 'nvim-surround', 'LuaSnip'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
