...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'nvim-treesitter', 'nvim-surround', 'smart-pairs', 'vim-moonfly-colors', 'gruvbox.nvim', 'LuaSnip'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
