...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'LuaSnip', 'smart-pairs', 'nvim-surround', 'gruvbox.nvim', 'vim-moonfly-colors', 'nvim-treesitter'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
