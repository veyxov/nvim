...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'nvim-surround', 'smart-pairs', 'vim-moonfly-colors', 'LuaSnip', 'nvim-treesitter', 'gruvbox.nvim'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
