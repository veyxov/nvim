...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'LuaSnip', 'smart-pairs', 'nvim-treesitter', 'gruvbox.nvim', 'nvim-surround', 'vim-moonfly-colors'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
