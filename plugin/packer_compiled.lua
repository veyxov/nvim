...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'smart-pairs', 'vim-moonfly-colors', 'nvim-surround', 'gruvbox.nvim', 'nvim-treesitter', 'LuaSnip'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
