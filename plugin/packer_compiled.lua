...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp_luasnip", "cmp-cmdline", "cmp-nvim-lsp", "LuaSnip", "cmp-path", "cmp-buffer" },
...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'indent-blankline.nvim', 'nvim-lspconfig'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
