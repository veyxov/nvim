...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-path", "cmp_luasnip", "cmp-nvim-lsp", "cmp-cmdline", "cmp-buffer", "LuaSnip" },
...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'nvim-lspconfig'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
