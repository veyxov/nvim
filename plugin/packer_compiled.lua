...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'LuaSnip', 'smart-pairs', 'gruvbox.nvim', 'vim-moonfly-colors', 'nvim-surround', 'nvim-treesitter'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
