...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-nvim-lsp", "cmp-path", "cmp-cmdline", "cmp_luasnip", "cmp-buffer" },
...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'LuaSnip', 'smart-pairs', 'nvim-surround', 'vim-moonfly-colors', 'gruvbox.nvim', 'nvim-treesitter'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
