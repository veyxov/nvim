...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-cmdline", "cmp-nvim-lsp", "cmp-path", "cmp-buffer", "cmp_luasnip" },
...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'LuaSnip', 'nvim-treesitter', 'gruvbox.nvim', 'vim-moonfly-colors', 'nvim-surround', 'smart-pairs'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
