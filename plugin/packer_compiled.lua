...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'smart-pairs', 'gruvbox.nvim', 'LuaSnip', 'nvim-treesitter', 'nvim-surround', 'vim-moonfly-colors'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
