...
_G.packer_plugins = {
  ...
  ["lightspeed.nvim"] = {
    config = { "\27LJ\2\nî\1\0\0\4\0\6\0\t6\0\0\0'\2\1\0B\0\2\0029\0\2\0005\2\3\0005\3\4\0=\3\5\2B\0\2\1K\0\1\0\17special_keys\1\0\2\21prev_match_group\n<tab>\21next_match_group\f<space>\1\0\1\16ignore_case\2\nsetup\15lightspeed\frequire\0" },
    loaded = true,
...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'smart-pairs', 'gruvbox.nvim', 'nvim-treesitter', 'LuaSnip', 'vim-moonfly-colors', 'nvim-surround'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
